...
import { ClassicNavType, menusConfig } from "@/config/menus";
...
const PopoverSidebar = ({ trans }: { trans: string }) => {
  ...
  const menus = allMenus.filter((item: ClassicNavType) => {
    // If no required role is specified, show the item
    if (!item.requiredRole) return true;

    // If user has one of the required roles, show the item
