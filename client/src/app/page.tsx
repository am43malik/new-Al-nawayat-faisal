    ...
    <div className="flex min-h-screen flex-col bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                  ...
                  <p className="text-gray-600 mb-6">
                    &quot;The products arrived faster than expected and the quality was excellent. I&apos;m very
                    satisfied with my purchase and will definitely shop here again!&quot;
                  </p>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 py-2 px-4">
        <div className="grid grid-cols-5 gap-1">
          ...
          <Link href="/category" className="flex flex-col items-center justify-center text-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              viewBox="0 0 24 24"
          ...
          <Link href="/cart" className="flex flex-col items-center justify-center text-gray-500">
            <div className="relative">
              <ShoppingBag className="h-6 w-6" />
              <Badge className="absolute -top-2 -right-2 h-4 w-4 p-0 flex items-center justify-center text-[10px]">
                3
          ...
          <Link href="/my-orders" className="flex flex-col items-center justify-center text-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              viewBox="0 0 24 24"
