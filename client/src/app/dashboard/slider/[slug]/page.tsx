...
export default function Page() {
  ...
  const breadcrumbItems = [
    { title: "Slider", link: "/dashboard/slider" },
    { title: "Add Images", link: "/dashboard/slider/new" },
  ];
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      if (values.images && values.images instanceof FileList) {
        ...
        <div className="container mx-auto">
          <Card className="max-w-5xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Add multiple images to your slider. Images will be displayed in
                  ...
                  <FormField
                    ...
                    render={({ field: { onChange, value, ...field } }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Upload square images (1920x800 px, max 3MB)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Toggle to set the slider as active or inactive
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
