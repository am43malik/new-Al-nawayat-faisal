...
import { getVendorById, updateVendor } from "@/lib/http/api";
...
export default function AddVendors() {
  const breadcrumbItems = [
    ...
    { title: "Update Vendor", link: "/dashboard/vendor/update" },
  ];
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      return await getVendorById(String(id)).then((res) => res.data);
    },
    enabled: !!id,
  });
  ...
  const { mutate, isPending } = useMutation({
    ...
    mutationFn: async (data: any) => {
      return await updateVendor(data, String(id));
    },
    onSuccess: (data) => {
      form.reset();
          ...
          <div className="container mx-auto">
            <Card className="max-w-5xl mx-auto">
              <CardHeader>
                ...
                <CardDescription>Update Vendor Detsials.</CardDescription>
              </CardHeader>
              <CardContent>
                <Form {...form}>
                  <form
